                                ...
                                <Grid key={image.id} item xs={12} sm={6} className="grid-item">
                                    <Card className={classes.card}>
                                        ...
                                        <CardContent>
                                            ...
                                            <div className="imageHashtags">
                                                {image.caption.text.split("\n")[1]}
                                            </div>
                                            <div>
                                                <IconButton className="like-button" aria-label="like-button" onClick={() => this.likeBtnHandler(image.id)}>
                                                    {image.user_has_liked ? <FavoriteIcon className="imageIconLiked" fontSize="large" /> : <FavoriteBorderIcon className="imageIconLike" fontSize="large" />}
                                                </IconButton>
                                                {image.likes.count === 1 ?
                                                    <span>
                                            ...
                                            <FormControl className={classes.comment} fullWidth={true}>
                                                ...
                                                <Input id="comment" className="commentText" name="commentText" onChange={(event) => this.onCommentTextChangeHandler(event, image.id)} value={image.id === this.state.commentText.id ? this.state.commentText.text : ""} />
