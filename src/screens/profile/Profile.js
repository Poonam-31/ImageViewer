                        ...
                        <div className="top">
                            ...
                            {this.state.isLoggedIn === true ?
                                <div className="flex-container">
                                    <div className="flex-container">
                                        <div className="left">
                                            <div className="profileSummary">
                                                <img className="profileImage" src={this.state.profilePicture} alt={this.state.fullName} />
                                            </div>
                                        </div>
                                        <div className="profileSummary-1">
                                    ...
                                    <div className="bottom imageMargins">
                                        ...
                                        <Modal isOpen={this.state.imageModalIsOpen} ariaHideApp={false} contentLabel="Label1" className="imageModal" onRequestClose={this.closeImageModalHandler} >
                                            <div className={classes.modalStyle}>
                                                <div className="modalLeft">
                                                    <img className="clickedImage" src={this.state.currImage} alt={this.state.curImgName} />
                                                </div>
                                                <div className="modalRight">
                                                    <div className="rightTop">
                                                        <img className="modalProfileIcon" src={this.state.currProfilePicture} alt={this.state.fullname} />
                                                        <span className="modalUsername">{this.state.username}</span>
                                                        <hr />
                                                    </div>
                                                    <div className="rightMiddle">
                                                        <div >{this.state.currCaption}</div>
                                                        <div className="imageHashtags">{this.state.currTags}</div>
                                                        <div className="commentsBlock">
                                                            {

                                                                this.state.comments.map(comment => (
                                                                    this.state.currId === comment.imageId ?
                                                                        <div className="commentDisplay" key={comment.id}>

                                                                            <Typography variant="subtitle2" className={classes.commentUsername} gutterbottom="true" >
                                                                                {comment.username}:
                                                                            </Typography>
                                                                            <Typography variant="body1" className="commentText" gutterbottom="true">
                                                                                {comment.text}
                                                                            </Typography>
                                                                        </div> : null
                                                                ))
                                                    ...
                                                    <div className="rightBotton">
                                                        <IconButton className="like-button" aria-label="like-button" onClick={() => this.likeBtnHandler(this.state.currId)}>
                                                            {this.state.currLikeStatus ? <FavoriteIcon className="imageIconLiked" fontSize="large" /> : <FavoriteBorderIcon className="imageIconLike" fontSize="large" />}
                                                        </IconButton>
                                                        ...
                                                        <FormControl className={classes.comment} fullWidth={true}>
                                                            ...
                                                            <Input id="comment" className="commentText" name="commentText" onChange={(event) => this.onCommentTextChangeHandler(event, this.state.currId)} value={this.state.currId === this.state.commentText.id ? this.state.commentText.text : ""} />
